...
public class SE_Shell : SE_Stats
{
	...
	public float resistModifier = 0.6f;
	...
	public override void UpdateStatusEffect(float dt)
	{
		if (doOnce)
		{
			...
			m_ttl = m_baseTTL + 0.3f * num;
			spiritDamageOffset = (6f + 0.3f * num) * VL_GlobalConfigs.g_DamageModifer * VL_GlobalConfigs.c_shamanShell;
			resistModifier = (0.6f - 0.006f * num) * VL_GlobalConfigs.c_shamanShell;
		}
