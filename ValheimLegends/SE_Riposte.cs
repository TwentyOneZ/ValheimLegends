...
public class SE_Riposte : StatusEffect
{
	...
	{
		if (ValheimLegends.vl_player == null || (ValheimLegends.vl_player.vl_class != ValheimLegends.PlayerClass.Rogue && ValheimLegends.vl_player.vl_class != ValheimLegends.PlayerClass.Duelist))
		{
			return true;
		}
		return base.IsDone();
