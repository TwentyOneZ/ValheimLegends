...
public class SE_Bulwark : StatusEffect
{
	...
	public override void OnDamaged(HitData hit, Character attacker)
	{
		...
		float num = Mathf.Clamp(0.75f - level
			* (1f + Mathf.Clamp((EpicMMOSystem.LevelSystem.Instance.getAddHp() / 400f) + (EpicMMOSystem.LevelSystem.Instance.getAddStamina() / 200f), 0f, 0.5f)) / 200f, 0.75f, 0.25f);
