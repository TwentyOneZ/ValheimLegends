...
public class SE_Bulwark : StatusEffect
{
	...
	{
		if (ValheimLegends.vl_player == null || ValheimLegends.vl_player.vl_class != ValheimLegends.PlayerClass.Valkyrie)
		{
			return true;
		}
		return base.IsDone();
	...
	{
		return base.CanAdd(character) && character.IsPlayer() && ValheimLegends.vl_player != null && ValheimLegends.vl_player.vl_class == ValheimLegends.PlayerClass.Valkyrie;
	}
}
